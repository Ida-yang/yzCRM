    ...
    <div>
        ...
        <el-table :data="tableData" ref="multipleTable" border stripe style="width:100%;" @selection-change="selectInfo">
            ...
            <div v-for="(item,index) in filterList" :key="index" >
                ...
                <el-table-column label="公司名称" prop="poolname" fixed v-if="item.prop == 'poolname' && item.state == 1" min-width="150" sortable />
                <el-table-column label="电话" prop="telephone" v-if="item.prop == 'telephone' && item.state == 1" sortable />
                <el-table-column label="手机" prop="phone" v-if="item.prop == 'phone' && item.state == 1" min-width="110" sortable />
                <el-table-column label="QQ" prop="qq" v-if="item.prop == 'qq' && item.state == 1" sortable />
                <el-table-column label="邮箱" prop="email" show-overflow-tooltip v-if="item.prop == 'email' && item.state == 1" min-width="95" sortable />
                <el-table-column label="微信" prop="wechat" v-if="item.prop == 'wechat' && item.state == 1" min-width="95" sortable />
                <el-table-column label="性别" prop="sex" v-if="item.prop == 'sex' && item.state == 1" min-width="95" sortable />
