                ...
                <div class="first_bottom">
                    ...
                    <div class="uploadBOX">
                        <div class="imgbox" v-for="(item,index) in fileList" :key="index">
                            <img :src="item.imgfile" alt="图片" @click="showImg($event,item)">
                        </div>
                    </div>
                </div>
                <div class="first_bottom">
                    ...
                    <el-table :data="tableData" border stripe style="width: 100%">
                        ...
                        <el-table-column label="主图" prop="imgfile" width="120">
                            <template slot-scope="scope">
                                <img :src="scope.row.imgfile" :alt="scope.row.imgfile" @click="showImg($event,scope.row)" width="100" height="100">
                            </template>
                        </el-table-column>
        ...
        methods:{
            loadData(){
                ...
                axios({
                    ...
                    _this.fileList = JSON.parse(res.data.goodsDesc.itemImages)
                    _this.fileList.forEach(a => {
                        if(a.value){
