    ...
    <div>
        ...
        <el-table :data="tableData" ref="multipleTable" border stripe style="width:100%" @selection-change="selectInfo" >
            ...
            <div v-for="(item,index) in filterList" :key="index" >
                ...
                <el-table-column label="公司名称" prop="name" fixed v-else-if="item.prop == 'name' && item.state == 1" min-width="200" sortable>
                ...
                <el-table-column label="电话" prop="contacts[0].telephone" v-else-if="item.prop == 'contacts[0].telephone' && item.state == 1" width="100" sortable />
                <el-table-column label="手机" prop="contacts[0].phone" v-else-if="item.prop == 'contacts[0].phone' && item.state == 1" width="110" sortable />
                <el-table-column label="QQ" prop="contacts[0].qq" v-else-if="item.prop == 'contacts[0].qq' && item.state == 1" min-width="80" sortable />
                ...
                <el-table-column label="最新跟进记录" prop="follow[0].followContent" v-else-if="item.prop == 'follow[0].followContent' && item.state == 1" show-overflow-tooltip min-width="130" sortable />
                ...
                <el-table-column label="前负责人" prop="privateUser[0].private_employee" v-else-if="item.prop == 'privateUser[0].private_employee' && item.state == 1" min-width="110" sortable />
                <el-table-column label="部门" prop="deptname" v-else-if="item.prop == 'deptname' && item.state == 1" min-width="110" sortable />
                <el-table-column label="机构" prop="parentname" v-else-if="item.prop == 'parentname' && item.state == 1" min-width="110" sortable />
                ...
                <el-table-column label="状态" prop="state" v-else-if="item.prop == 'state' && item.state == 1" min-width="100" sortable />
                <el-table-column label="线索来源" prop="cues" v-else-if="item.prop == 'cues' && item.state == 1" min-width="110" sortable />
                ...
                <el-table-column label="注册号" prop="registrationNumber" v-else-if="item.prop == 'registrationNumber' && item.state == 1" min-width="130" sortable />
