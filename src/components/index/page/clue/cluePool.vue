    ...
    <div>
        ...
        <el-table :data="tableData" ref="multipleTable" border stripe style="width:100%" @selection-change="selectInfo" >
            ...
            <div v-for="(item,index) in filterList" :key="index" >
                ...
                <el-table-column label="最新跟进记录" prop="follow[0].followContent" v-if="item.prop == 'follow[0].followContent' && item.state == 1" show-overflow-tooltip min-width="130" sortable />
                ...
                <el-table-column label="状态" prop="state" v-if="item.prop == 'state' && item.state == 1" min-width="100" sortable />
