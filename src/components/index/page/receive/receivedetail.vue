        ...
        <div class="top">
                <el-card class="box-card" v-model="receivdetailData">
                    <div slot="header" class="clearfix">
                        ...
                        <el-button style="float:right;" class="info-btn" size="mini" @click="showexamine(1)" v-show="hasCheck && receivdetailData.checkStatus !== 2">通过</el-button>
                        <el-button style="float:right;" class="info-btn" size="mini" @click="showexamine(2)" v-show="hasCheck && receivdetailData.checkStatus !== 2">拒绝</el-button>
