    ...
    <div class="orderadd_c">
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                <span class="bold_span">订单收款单</span>
            </div>
            <div class="orderHead">
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit(){
                ...
                if(more0){
                    _this.$message({
                        message: more0.orderNo + "：本次收款金额不能大于未收款金额",
                        type: 'error'
                    });
                    flag = true
                }
                ...
                axios({
                    ...
                    if(res.data.code && res.data.code == '200'){
                        ...
                        let info = res.data.map.orderBack
                        console.log(info)
                        _this.$store.state.orderReceiveDetailData = {id:info.id, batch_id: info.batch_id};
                        _this.closeTag();
                        _this.$router.push({ path: '/orderReceiveDetail' });
                    }else{
                        _this.$message({
